...
const findOneResume = async applicantId => {
  const query = 'SELECT a.id, t.id as teams_id, t.name as teams_name, a.name, a.email, a.phone, a.application_status, a.application_time, q.content as question, q.number, n.content as answer ' +
    'FROM teams as t ' +
